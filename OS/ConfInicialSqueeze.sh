...
#
#-------------------------------------------------------------------------
# Note: This Shell Script set up the initial configuration to Debian Squeeze
...
# Version 1:
# Data: 06/04/2014
# Description: Set up the initial configuration of Debian GNU/Linux Squeeze
...
# Backport repository
#deb http://ftp.br.debian.org/debian squeeze-backports main contrib non-free
#deb-src http://ftp.br.debian.org/debian squeeze-backports main contrib non-free
