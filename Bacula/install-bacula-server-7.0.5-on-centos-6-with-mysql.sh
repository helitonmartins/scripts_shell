...
${YUM} check-update
${YUM} update -y  || { echo "${RED}FALHA AO ATUALIZAR O APTITUDE ${CLOSE}"; exit 1; }
...
readline-devel readline-static readline zlib zlib-devel zlib-static libmcrypto-devel openssl-devel -y  || { echo "${RED}FALHA AO ATUALIZAR O APTITUDE ${CLOSE}"; exit 1; }
